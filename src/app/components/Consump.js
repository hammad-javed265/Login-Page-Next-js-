...
function Consump({ id, children, title, xltop }) {
    return (
        <div className={`bg-[#161232] text-white opacity-80 border-b-2 border-white hover:bg-white hover:text-[#161232] p-4 w-full sm:w-full md:w-[47%] lg:w-[47%] xl:w-[23%] mt-3 relative ${xltop}`}>
            <div
