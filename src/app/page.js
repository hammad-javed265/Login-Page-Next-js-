...
function page() {
  return (
    <div className='p-2'>
      ...
      <NavList></NavList>
      {/* navbar ends */}
      <div className="flex flex-wrap space-x-6 space-y-6 sm:h-full md:h-[130vh] lg:h-[100vh] xl:h-[95vh]">
        <div className="flex flex-wrap flex-col w-full h-full">
          <Div id={"div1"} title={"Live Energy Consumption"} length={"lg:w-[26%] xl:w-[26%] mr-6"} heig = "md:h-[404px] lg:h-[404px] xl:h-[380px]"><GaugeChart></GaugeChart></Div>
          <Div id={"div7"} title={"Radius Pie Chart"} length={"lg:w-[26%] xl:w-[26%] mr-6"} heig = "md:h-[404px] lg:h-[404px] xl:h-[380px]"><Radiuspie></Radiuspie></Div>
          ...
          <Div id={"div5"} title={"Pie Chart"} length={"lg:w-[26%] xl:w-[26%]  mt-6"} heig = "md:h-[404px] lg:h-[404px] xl:h-[380px]"><PieChart></PieChart></Div>
          <Div id={"div6"} title={"Donut Chart"} length={"lg:w-[26%] xl:w-[26%] "} heig = "md:h-[404px] lg:h-[404px] xl:h-[380px]"><Donut></Donut></Div>
