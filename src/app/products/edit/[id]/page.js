...
const NewProduct = ({params}) => {
  ...
  const editHandler = async (e) => {
    try {
      ...
      const response =  await axios.put(`/api/products/${params.id}`, {title:name, description, price});   
  ...
  return (
    <AdminLayout>
      <h3 className='text-2xl font-bold pb-5'>Edit Product</h3>
      
      <form onSubmit={editHandler} className='flex flex-col gap-2'>
